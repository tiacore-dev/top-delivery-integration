...
def save_scanning_results(shipment_id, order_ids):
...
def set_problem_status(order_id, problem_status, note=""):
...
def set_sent_to_delivery(order_id, date_sent_to_delivery, delivery_type=None, service_id=None, delivery_params=None):
